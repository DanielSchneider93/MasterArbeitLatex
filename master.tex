...
\newcommand*{\IhreSchluesselwoerter}{Photogrammetrie, Augmented Reality, standortbezogene Daten, Android, Java}
...
\begin{document}
  ...
  \begin{thebibliography}{10}
    ...
    \bibitem[2]{slam} Hugh Durrant-Whyte, Tim Bailey (2006), Simultaneous Localisation and Mapping (SLAM): Part I The Essential Algorithms. \url {https://people.eecs.berkeley.edu/~pabbeel/cs287-fa09/readings/Durrant-Whyte_Bailey_SLAM-tutorial-I.pdf} (Zuletzt abgerufen am 09.07.2019)
    

\bibitem[3]{slam_mobile} Pierre Martin, Eric Marchand, Pascal Houlier, Isabelle Marchal. Mapping and re-localization for mobile augmented reality. IEEE Int. Conf. on Image Processing, Oct 2014, Paris, France.
\url{https://hal.inria.fr/hal-00994756/document} (Zuletzt abgerufen am 09.07.2019) 
